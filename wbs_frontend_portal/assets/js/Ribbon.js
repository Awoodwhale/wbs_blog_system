function RibbonsBase() {
    ...
    var mouseInfo = function (e) {
        ...
        return {
            mousex: mousex, mousey: mousey, centerx: mousex - screen.width / 2, centery: mousey - screen.height / 2
        };
    };
    ...
    var Factory = function (options) {
        ...
        this._options = {
            //色带颜色HSL饱和度
            colorSaturation: "80%", //色带颜色HSL亮度量
            colorBrightness: "60%", //色带颜色不透明度量
            colorAlpha: 0.65, //在HSL颜色空间中循环颜色的速度有多快
            colorCycleSpeed: 6, // 每侧Y轴上的起始位置 (top|min, middle|center, bottom|max, random)
            verticalPosition: "random", //到达屏幕另一边的速度有多快
            horizontalSpeed: 200, //在任何给定时间屏幕上保留多少条色带
            ribbonCount: 5, //添加笔划和功能区填充颜色
            strokeSize: 0, //按页面滚动上的系数垂直移动功能区
            parallaxAmount: -0.5, //随时间向每个功能区区域添加动画效果
